...
import type { Error as _Error, Profile as _Profile, Result as _Result, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async __answersState(): Promise<any> {
        if (this.processError) {
            try {
    ...
    async __profileState(): Promise<any> {
        if (this.processError) {
            try {
    ...
    async generateAnswer(arg0: string): Promise<GeneratedAnswer> {
        if (this.processError) {
            try {
    ...
    async getProfileCharCount(): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async recentAnswers(): Promise<Array<GeneratedAnswer>> {
        if (this.processError) {
            try {
