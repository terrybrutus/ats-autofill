...
export interface Profile { 'text' : string, 'updatedAt' : bigint }
...
export interface _SERVICE {
  ...
  'generateAnswer' : ActorMethod<[string], GeneratedAnswer>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getProfile' : ActorMethod<[], [] | [Profile]>,
  'getProfileCharCount' : ActorMethod<[], bigint>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'recentAnswers' : ActorMethod<[], Array<GeneratedAnswer>>,
